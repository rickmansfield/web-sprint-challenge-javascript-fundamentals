  ...
  */
  ...
  function animalNames(array){
    ...
    array.forEach(function(item){
      habitats.push(`name: ${item.animal_name}, scientific: ${item.scientific_name}`);
    });
    return habitats;
  }
...
//see above I already converted some to demonstrate both ways
...
const cubeMakerTwo = new CubeMaker({
  length: 3,
});

console.log(`STRETCH Volue`,cubeMakerTwo.volume()); // 27
console.log(`STRETCH Surface Area`,cubeMakerTwo.surfaceArea()); // 54
